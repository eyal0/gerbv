...
# $1 = 1 on initial installation, $1 = 2 on upgrade

PREFIX="/opt/gerbv.github"

# Only perform integration on initial install, not on upgrade
if [ "$1" -eq 1 ]; then
...
# Update desktop database and icon cache on both install and upgrade
